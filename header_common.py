...
multiplayer_event_admin						              	  = 48
me_admin_set_deadly_bow				= 0
me_admin_set_invasion_difficulty	= 1
me_admin_reset_map					= 2
me_admin_slay_bots					= 3
me_admin_slay_player				= 4
me_admin_heal_player				= 5
me_admin_swap_player_team			= 6
me_admin_swap_player_spectator		= 7
me_admin_give_thors_hammer			= 8
me_admin_beacon_player				= 9
me_admin_set_allow_shield_bash		= 10
me_admin_set_allow_fall_from_horse	= 11
me_admin_set_allow_shieldwall		= 12
me_admin_set_remove_stray_horses	= 13
me_admin_set_god_mode				= 14
me_admin_set_troop_classes			= 15
me_admin_slay_horses				= 16
me_admin_refill_player				= 17
me_admin_fix_player_shield			= 18
me_admin_teleport_me				= 19
me_admin_teleport_him				= 20
me_admin_immortal					= 21
me_admin_force_master				= 22
me_admin_set_gametype_voteable		= 23
me_admin_set_poll_cooldown			= 24
...
multiplayer_event_return						              = 113
me_return_deadly_bow			= 0
me_return_invasion_data			= 1
me_return_invasion_difficulty	= 2
me_return_beaconed_player		= 3
me_return_allow_shield_bash		= 4
me_return_allow_fall_from_horse	= 5
me_return_allow_shieldwall		= 6
me_return_thors_champion_agent	= 7
me_return_remove_stray_horses	= 8
me_return_god_mode				= 9
me_return_troop_classes			= 10
me_return_immortal_player		= 11
me_return_gametype_voteable		= 12
me_return_poll_cooldown			= 13
me_return_poll_cooldown_failed	= 14

multiplayer_event_admin_chat								  = 114
multiplayer_event_admin_message								  = 115

multiplayer_event_give_order_to_class						= 116
multiplayer_event_class_orders								= 117
me_class_order_select	= 0
me_class_order_return	= 1


# clients can only recieve up to multiplayer_event = 127
######multiplayer chief
#multiplayer_event_taunt_server                                = 113
#multiplayer_event_message_server                              = 114
#multiplayer_event_sound_made_by_player                        = 115
#multiplayer_event_sound_at_player                             = 116
#multiplayer_event_animation_at_player                         = 117
#multiplayer_event_message_client                              = 118
multiplayer_event_start_capitan_mode                          = 119 #chief capitan
...
multiplayer_event_ship										 = 120
me_ship_inrease_speed	= 0
me_ship_decrease_speed	= 1
me_ship_turn_right		= 2
me_ship_turn_left		= 3
me_ship_set_sail		= 4
me_ship_return_player_ship = 5
me_ship_return_ship_sail   = 6
me_ship_return_ship_rowing = 7
me_ship_return_ship_rudder = 8
me_ship_return_ship_speed  = 9
me_ship_return_ship_crew   = 10
me_ship_return_ship_type   = 11
me_ship_return_ship_landed = 12
me_ship_return_ship_sail_and_rowing = 13
me_ship_return_wind		   = 14
me_ship_do_thunder		   = 15
multiplayer_event_ship_send_data							 = 121

multiplayer_event_agent										 = 122
me_agent_play_animation		= 0
me_agent_use_horn			= 1
me_agent_berserk			= 2
me_agent_shield_taunt		= 3
me_agent_decapitate			= 4
me_agent_critical_recieved	= 5
me_agent_critical_dealt		= 6
me_agent_blinded			= 7
me_agent_is_chosen			= 8
me_agent_shield_bash		= 9

multiplayer_event_display_string							 = 123
multiplayer_event_display_message							 = 124
me_message_berserk_begin		= 0
me_message_berserk_loss			= 1
me_message_berserk_end			= 2
me_message_berserk_cooldown		= 3
me_message_horn_ally			= 4
me_message_horn_enemy			= 5
me_message_horn_end				= 6
me_message_horn_player_ally		= 7
me_message_horn_player_enemy	= 8
me_message_horn_cooldown		= 9
me_message_supply_box_used		= 10
me_message_banner_bonus_active	= 11
me_message_banner_bonus_end		= 12
me_message_shieldwall_bonus		= 13
multiplayer_event_sync_shader								 = 125
...
multiplayer_game_type_siege                  = 3
multiplayer_game_type_duel                   = 4
multiplayer_game_type_sea                    = 5 #naval battles
multiplayer_game_type_thor                   = 6 #thor's champion
multiplayer_game_type_invasion               = 7 #draugr invasion
multiplayer_game_type_lords_battle           = 8 #chief capitan
multiplayer_game_type_raid                   = 9
...
multiplayer_poll_cooldown = 180 #3 minutes (delay between polls)
...
reg59  = opmask_register|59 #reserved for player gender
