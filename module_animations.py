...
##   [0.8, "jump_end_hard", 29, 54, arf_blend_in_1],
 ...
 ["stand_single", 0, amf_client_prediction,
   ...
   [34.0, "stand_onehanded_1", 0, 42, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],
   [40.0, "stand_onehanded_2", 0, 42, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],
   [37.0, "stand_onehanded_3", 0, 42, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],
 ],
 ...
 ["stand_staff", 0, amf_client_prediction,
   ...
   [30.0, "stand_spear_1", 0, 64, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.0],
   [33.0, "stand_spear_2", 0, 64, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.0],
   [42.0, "stand_spear_3", 0, 64, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.0],
   [39.0, "stand_spear_4", 0, 64, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.0],
   [36.0, "stand_spear_5", 0, 64, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.0],
 ],
...
["walk_right", acf_enforce_lowerbody, amf_use_cycle_period|amf_client_prediction,
 ...
 ["walk_forward_crouch", acf_enforce_lowerbody, 0,
   [1.7, "low_walk", 0, 48, arf_use_walk_progress|arf_cyclic|blend_in_walk|arf_make_walk_sound,pack2f(0.4,0.9)],
 ],
...
##   [1.0, "throw_stone", 21, 54, arf_blend_in_0],
 ...
 ["ready_pistol", acf_rot_vertical_bow, amf_priority_attack|amf_keep|amf_use_cycle_period|amf_client_owner_prediction|amf_rider_rot_throw,
   [0.9, "sling", 0, 31, arf_cyclic|blend_in_ready],
 ],
 ["release_pistol", acf_rot_vertical_bow, amf_priority_throw|amf_use_weapon_speed|amf_play|amf_client_owner_prediction|amf_rider_rot_throw,
 ...
 ["ready_musket", acf_rot_vertical_bow, amf_priority_attack|amf_use_weapon_speed|amf_keep|amf_client_owner_prediction|amf_rider_rot_throw,#amf_use_cycle_period|
   [0.6, "staff_sling", 0, 19, blend_in_ready], 
 ],
 ["release_musket", acf_rot_vertical_bow, amf_priority_throw|amf_use_weapon_speed|amf_play|amf_client_owner_prediction|amf_rider_rot_throw,
   [0.7, "staff_sling", 28, 56, arf_blend_in_0],
 ],
...
#   [defend_duration, "defend_shield_parry_all", 5, 26, blend_in_defense], 
 ...
 ["defend_shield_keep", acf_parallels_for_look_slope|acf_anim_length(100), amf_rider_rot_shield|amf_priority_defend|amf_keep|amf_rider_rot_defend|amf_client_owner_prediction,
   [defend_keep_duration, "dedal_shield", defend+118, defend+120, arf_blend_in_4|arf_cyclic], 
 ],
 ["defend_shield_parry_1", acf_parallels_for_look_slope|acf_anim_length(100), amf_priority_defend_parry|amf_play|amf_restart|amf_rider_rot_shield,
   [defend_parry_duration_1, "dedal_shield", defend+121, defend+130, arf_blend_in_1], 
 ],
 ["defend_shield_parry_2", acf_parallels_for_look_slope|acf_anim_length(100), amf_priority_defend_parry|amf_play|amf_restart|amf_rider_rot_shield,
   [defend_parry_duration_2, "dedal_shield", defend+121, defend+130, arf_blend_in_1], 
 ],
 ["defend_shield_parry_3", acf_parallels_for_look_slope|acf_anim_length(100), amf_priority_defend_parry|amf_play|amf_restart|amf_rider_rot_shield,
   [defend_parry_duration_3, "dedal_shield", defend+121, defend+130, arf_blend_in_1], 
 ],
...
#   [10.0, "anim_human_temp", 0, 10, arf_blend_in_5], 
 ...
 ["crouch_unarmed", 0, amf_client_prediction,
   ...
   #[1.0,"low_walk",37,39,arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],
   [8, "noweapon_cstance", 0, 100, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],
 ],
 ...
 ["crouch_ready_pistol", acf_rot_vertical_sword|acf_anim_length(100), amf_priority_attack|amf_use_weapon_speed|amf_keep|amf_client_owner_prediction|amf_rider_rot_pistol,
   ...
   #[1.0,"anim_human",0,1,0],
   [0.6, "sling", 0, 31, arf_cyclic|blend_in_ready],
 ],
 ...
 ["ready_overswing_musket", acf_rot_vertical_sword| acf_overswing, amf_priority_attack|amf_use_weapon_speed|amf_use_inertia|amf_keep|amf_client_owner_prediction|amf_rider_rot_thrust,
  [ready_durn, "onehanded_overhead_stab_ready", 0, 10, blend_in_ready],
 ],
 ["release_overswing_musket", acf_rot_vertical_sword|acf_overswing, amf_priority_attack|amf_use_weapon_speed|amf_play|amf_continue_to_next|amf_rider_rot_thrust,
  [0.4, "onehanded_overhead_stab", 55, 70, blend_in_release],#78
 ],
...
###
 ["horn", acf_enforce_all, amf_play|amf_priority_reload|amf_accurate_body,
  [7, "horn", 2, 47, arf_blend_in_10],
 ],
 ["shield_taunt", acf_enforce_all|acf_rot_vertical_sword, amf_play|amf_restart|amf_priority_reload|amf_accurate_body,
   [1, "shield_taunt", 0, 12, arf_blend_in_8],
 ],
...
["thrust_onehanded_overhead", acf_thrust|acf_rot_vertical_bow|acf_anim_length(100), amf_priority_attack|amf_use_weapon_speed|amf_play,
  [0.45, "javelin_thrust_overhead", 55, 78, blend_in_release], 
],
...
# ["unused_human_anim_66", 0, 0, [1.0, "anim_human", 0, 1, 0]],
 ["berserker_trance", 0, amf_play|amf_priority_reload|amf_accurate_body,
...
##   [2.5, "anim_horse", 505, 580,  arf_blend_in_8],
 ...
 ["cow_stand", acf_enforce_all, amf_priority_die|amf_keep,
   [6, "cow_stand_whole", 0, 18, arf_blend_in_128|arf_cyclic|arf_use_stand_progress, 0, (0, 0, 0), 0.0],
   [6, "cow_stand_whole", 0, 18, arf_blend_in_128|arf_cyclic|arf_use_stand_progress, 0, (0, 0, 0), 0.0],
   [10, "cow_stand_whole", 25, 53, arf_blend_in_128|arf_cyclic|arf_use_stand_progress, 0, (0, 0, 0), 0.0],
   [6, "cow_stand_whole", 0, 18, arf_blend_in_128|arf_cyclic|arf_use_stand_progress, 0, (0, 0, 0), 0.0],
   [6, "cow_stand_whole", 0, 18, arf_blend_in_128|arf_cyclic|arf_use_stand_progress, 0, (0, 0, 0), 0.0],
 ],
