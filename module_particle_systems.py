...
##    
    ("game_blood", psf_billboard_3d |psf_randomize_size|psf_randomize_rotation,  "prt_mesh_blood_1",
     50, 0.65, 3, 0.5, 0, 0,        #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
    ...
    ("game_blood_2", psf_billboard_3d | psf_randomize_size|psf_randomize_rotation ,  "prt_mesh_blood_3",
     200, 0.6, 3, 0.3, 0, 0,        #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
    ...
    ("game_blood_3", psf_billboard_3d | psf_randomize_size|psf_randomize_rotation ,  "prt_mesh_blood_3",
     400, 6, 1, 0.8, 20, 20,        #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
     (0.1, 0.3), (1, 0.01),          #alpha keys
     (0.1, 0.7), (1, 0.7),      #red keys
     (0.1, 0.7), (1, 0.7),       #green keys
     (0.1, 0.7), (1, 0.7),      #blue keys
     (0.1, 1.1),   (1, 9.75),  #scale keys
     (0, 0.08, 0),               #emit box size
     (0.7, 1.3, 2 ),                #emit velocity
     0.3,                       #emit dir randomness
     150,                         #rotation speed
...
#phaiak end
    ...
    ("explosive_explosion_sparks_a", psf_billboard_3d|psf_randomize_size, "prt_sparks_mesh_1",
     200, 0.150000, 0.400000, 0.200000, 3.000000, 10.000000,
     (0.600000, 1.000000), (0.700000, 0.000000),
     (1.000000, 1.000000), (1.000000, 0.000000),
     (1.000000, 0.700000), (0.300000, 0.000000),
     (0.000000, 0.000000), (0.000000, 0.000000),
     (0.000000, 40.000000), (0.300000, 0.300000),
    ...
    ("explosive_explosion_sparks_b", psf_billboard_3d|psf_randomize_size, "prt_sparks_mesh_1",
     200, 0.300000, 0.400000, 0.200000, 3.000000, 10.000000,
     (0.600000, 1.000000), (0.700000, 0.000000),
     (1.000000, 1.000000), (1.000000, 0.000000),
     (0.700000, 0.500000), (0.300000, 0.000000),
     (0.000000, 0.000000), (0.000000, 0.000000),
     (0.000000, 40.000000), (0.300000, 0.300000),
     (0.500000, 0.500000, 0.500000),
     (0.500000, 0.500000, 0.500000),
    ...
    ("explosion_dirt", psf_billboard_2d|psf_randomize_rotation|psf_randomize_size|psf_2d_turbulance, "prt_mesh_mud_1",
     400, 3.000000, 0.600000, 3.000000, 0.000000, 0.000000,
     (1.000000, 1.000000), (1.000000, 0.000000),
    ...
    90, 10.000000, 0.600000, -0.200000, 60.000000, 1.500000,
    (0.000000, 1.000000), (0.700000, 0.500000),
    (0.000000, 0.400000), (0.300000, 0.200000),
    (0.000000, 0.400000), (0.300000, 0.200000),
    (0.000000, 0.400000), (0.300000, 0.200000),
    (0.000000, 5.000000), (25.000000, 60.000000),
